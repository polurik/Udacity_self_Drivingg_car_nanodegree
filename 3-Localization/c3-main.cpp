...

{
    ...
    Eigen::Matrix4d initTransform = transform3D(startPose.rotation.yaw, startPose.rotation.pitch, startPose.rotation.roll,startPose.position.x,startPose.position.y,startPose.position.z);
...
Eigen::Matrix4d NDT(PointCloudT::Ptr mapCloud, PointCloudT::Ptr source, Pose startingPose, int iterations, int resolution)
{
 ...
 //   printf("\n%s\n\n", USE_NDT ? "Using Alg 1: Normal Distribution" : "Using Alg 2: ICP");
 //   int n_scans = 0;
         ...
         //   }
           ...
           // n_scans++;
            ...
            //Eigen::Matrix4d matching_transform = USE_NDT ? NDT(mapCloud, cloudFiltered, pose) :        ICP(mapCloud,cloudFiltered, pose);
              ...
              Eigen::Matrix4d matching_transform = NDT(mapCloud, cloudFiltered, pose , 130,10);
          //ICP(mapCloud,cloudFiltered, pose);
